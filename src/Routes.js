	...
	return (
		<div className='App' alt='test1'>
			<Switch>
				...
				<ProtectedRoute exact path='/company-matches' component={CompanyMatch} />

				<ProtectedRoute exact path='/seeker-matches' component={SeekerMatch} />

				<ProtectedRoute exact path='/company-profile' component={FormikCompanyProfile} />

				<ProtectedRoute exact path='/seeker-profile' component={FormikSeekerProfile} />
